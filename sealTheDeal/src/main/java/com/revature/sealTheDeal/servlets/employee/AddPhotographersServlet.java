...
public class AddPhotographersServlet extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (serviceName.trim().isEmpty() || req.getParameter("price").trim().isEmpty()) {
			...
			out.println(
					"<meta http-equiv=\"refresh\" content=\"0; URL=http://localhost:8080/sealTheDeal/employeeHome/addPhotogaphers/\">");
			...
			out.println(
					"<meta http-equiv=\"refresh\" content=\"0; URL=http://localhost:8080/sealTheDeal/employeeHome/addPhotographers/\">");
		}
